...
public class CircleProgressBar extends View {
    ...
    private void initPaints(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, pick.com.app.R.styleable.CircleProgresddddsBar, defStyleAttr, 0);

        progressColor = ta.getColor(R.styleable.CircleProgresddddsBar_backgroundColor, Color.BLUE);
        backgroundColor = ta.getColor(R.styleable.CircleProgresddddsBar_backgroundColor, Color.GRAY);
        strokeWidth =  10;
        backgroundWidth = ta.getFloat(R.styleable.CircleProgresddddsBar_backgroundWidth, 10);
        roundedCorners = ta.getBoolean(R.styleable.CircleProgresddddsBar_roundedCorners, false);
        maxValue = ta.getFloat(R.styleable.CircleProgresddddsBar_maxValue, 100);
        progressTextColor = ta.getColor(R.styleable.CircleProgresddddsBar_progressTextColor, Color.BLACK);
        textSize = ta.getDimension(R.styleable.CircleProgresddddsBar_textSize, 18);
        suffix = ta.getString(R.styleable.CircleProgresddddsBar_suffix);
        prefix = ta.getString(R.styleable.CircleProgresddddsBar_prefix);
        text = ta.getString(R.styleable.CircleProgresddddsBar_progressText);
